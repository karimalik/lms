                                ...
                                <form action="{{route('blogs.update')}}" method="POST"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xl-12 courseBox mb-25">
                                            ...
                                            <select class="primary_select category_id" name="category"
                                                    id="editCategory" {{$errors->has('category') ? 'autofocus' : ''}}>
                                                <option data-display="{{__('common.Select')}} {{__('quiz.Category')}} *"
                                                        value="">{{__('common.Select')}} {{__('quiz.Category')}} </option>
                                                @foreach($categories as $category)
                                                    <option value="{{$category->id}}">{{@$category->title}} </option>
                                        ...
                                        <div class="col-xl-12 courseBox mb-25" id="">


                                            <div class="primary_input mb-25">
                                                <label class="primary_input_label"
                                                       for="">  {{ __('common.Tags') }} <small>must be Comma(,)
                                                        separated</small>

                                                </label>
                                                <input type="text" data-role="tagsinput" name="tags" id="" value=""
                                                       class="primary_input_field editTag">
