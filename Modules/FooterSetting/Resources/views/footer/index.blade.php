                                                    ...
                                                    <div class="col-xl-12">
                                                        <div class="primary_input mb-35">
                                                            ...
                                                            <textarea required name="value"
                                                                      ...
                                                                      id="copy_right">{!! Settings('footer_copy_right') !!}</textarea>
                                                        </div>
                                                    ...
                                                    <div class="col-lg-12">
                                                        <div class="input-effect">
                                                            <textarea class="primary-input form-control read-only-input"
                                                                      name="value" required
                                                                      id="about_description">{!! Settings('footer_about_description') !!}</textarea>
                                                ...
                                                <div class="white-box">
                                                    <div class="add-visitor">
                                                        <div class="row">
                                                            <div class="col-lg-12">
                                                                <div class="input-effect">
                                                                    <input type="hidden" value="footer_section_one_title" name="key">
                                                                    <input
                                                                        class="primary-input form-control read-only-input"
                                                                        required
                                                                        type="text" name="value"
                                                                        autocomplete="off"
                                                                        value="{{Settings('footer_section_one_title')}}">
                                                                    <label>{{__('footer.Section name')}}
                                                                        <span>*</span></label>
                                                                    <span class="focus-border"></span>
                                                                </div>
                                                            ...
                                                            <div class="col-lg-12">
                                                                <div class="input-effect">
                                                                    <input
                                                                        ...
                                                                        type="text" name="value"
                                                                        autocomplete="off"
                                                                        value="{{Settings('footer_section_two_title')}}">
                                                                    <label>{{__('footer.Section name')}}
                                                                        <span>*</span></label>
                                                                    <span class="focus-border"></span>
                                                                </div>
                                                            ...
                                                            <div class="col-lg-12">
                                                                <div class="input-effect">
                                                                    <input
                                                                        ...
                                                                        type="text" name="value"
                                                                        autocomplete="off"
                                                                        value="{{Settings('footer_section_three_title')}}">
                                                                    <label>{{__('footer.Section name')}}
                                                                        <span>*</span></label>
                                                                    <span class="focus-border"></span>
                                                                </div>
