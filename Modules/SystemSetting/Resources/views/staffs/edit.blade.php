                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-6 employee_id_div">
                                <div class="primary_input mb-25">
                                    ...
                                    <input name="phone" id="phone" class="primary_input_field name" placeholder="{{ __('common.Phone') }}" value="{{ $staff->phone }}" type="text">
                                ...
                                <div class="primary_input mb-15">
                                    ...
                                    <div class="primary_datepicker_input">
                                        <div class="no-gutters input-right-icon">
                                            <div class="col">
                                                <div class="">
                                                    <input placeholder="Date" class="primary_input_field primary-input date form-control" id="date_of_birth" type="text" name="date_of_birth" value="{{ $staff->date_of_birth?date('m/d/Y', strtotime($staff->date_of_birth)):'' }}" autocomplete="off" required>
                                                </div>
                                            </div>
...
{{--                            </div>--}}
                            ...
                            <div class="col-xl-6 provisional_time_div">
                                <div class="primary_input mb-25">
                                    ...
                                    <input name="provisional_months" id="provisional_time" class="primary_input_field name" placeholder="0" type="number" value="{{ $staff->provisional_months }}">
