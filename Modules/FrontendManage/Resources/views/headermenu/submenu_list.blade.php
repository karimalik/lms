                                                                    ...
                                                                    <div class="col-lg-6 mb-25">
                                                                        <div
                                                                            ...
                                                                            <label class="primary_checkbox d-flex mr-12">
                                                                                ...
                                                                                <span class="checkmark mr-2"></span> {{ __('Left') }}
                                                                            </label>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-lg-6 mb-25">
                                                                        ...
                                                                        <div
                                                                            ...
                                                                            <label class="primary_checkbox d-flex mr-12">
                                                                                ...
                                                                                <span class="checkmark mr-2"></span> {{ __('Right') }}
                                                                            </label>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div class="primary_input">
                                                                <div class="row">
                                                                    <div class="col-lg-12">
                                                                        ...
                                                                        <label class="primary_checkbox d-flex mr-12" style="width: 100%;">
                                                                            <input type="checkbox" name="is_newtab"
                                                                                   id="is_newtab_{{$element->id}}"

                                                                                   value="1" {{$element->is_newtab == 1? 'checked':''}}>
                                                                            <span class="checkmark mr-2"></span> {{ __('Open link in a new tab') }}
                                                                        </label>
                                                                    </div>
                                                                </div>
                                                            </div>
