        ...
        <div class="billing_details_wrapper">
            <div class="biling_address gray-bg">
                ...
                <div class="biling_body_content">
                    ...
                    <p>{{ @$checkout->billing->stateDetails->name }},{{ @$checkout->billing->cityDetails->name }} - {{ @$checkout->billing->zip_code }} </p>
                                                                ...
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-body">
                                                                        <div class="row">
                                                                            ...
                                                                            @endphp
                                                                            <div class="col-md-12">
                                                                                @include('mercadopago::partials._checkout',compact('total_amount','checkout'))
                                                                            </div>
                                                                        </div>
